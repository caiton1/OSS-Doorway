...
Quests:
  ...
  - Quest 2 - Introducing yourself to the community
    ...
    - Task 4 - [Mention a contributor that has most recently been active in the project to help you solve the issue](https://github.com/caiton1/OSS-Doorway/issues/29)
